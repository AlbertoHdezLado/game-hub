...
export function CodigoSecretoPage() {
  ...
  useEffect(() => { loadContent<Content>('codigo-secreto-words.json').then((data) => { setCategories(data.categorias); setSelectedIds(data.categorias.map((category) => category.id)); }); }, []);
